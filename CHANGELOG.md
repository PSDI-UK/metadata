...
* Updates to psdi-dcat.jsonld and psdi-dcat.ttl to update ChASe and Propersea, PChProp, "Data to Knowledge" resources, automatically generated citations, qualified attributions, and landing pages of all data sources made available via cross data search:
   ...
   * changed distribution/ of most other resources available via PSDI Cross Data Search so that they are now the url which points to a search of just them in the PSDI Cross Data Search. This affects these resources:
      ...
      * "STFC Open Data" (https://resources.psdi.ac.uk/data/01c14e6c-7dd2-4e25-96f2-75bb02400ed6 )
      * "Catalysis Data Infrastructure (CDI) Data Objects" (https://resources.psdi.ac.uk/data/530ae29a-89eb-4562-b918-1fb66d8bfdb2 )
      * "Catalysis Data Infrastructure (CDI) Publications" (https://resources.psdi.ac.uk/data/caca6b34-2c2a-41ab-a1b3-2b789cc76421  )
      * all data resources in "OPTIMADE Data Providers" (https://resources.psdi.ac.uk/resource-theme/33e34aed-745c-412c-8e90-f11bb2270a38 )
   * changed citation format of all resource themes/resources which are autogenerated by automate_citations.py to align more with BS ISO 690:2021 and be of the form "Please cite: AUTHOR_NAMES. RESOURCE_TITLE. Online. Version VERSION_NUMBER. ISSUED DATE. Available from: RESOURCE_LANDING_PAGE. [accessed YYYY-MM-DD].".
   * changed urls of qualified attribution roles to be of the form e.g. https://schemas.isotc211.org/Resources/codelists.xml#ISO19115-1.1.cit.CI_RoleCode_collaborator rather than http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml:isotc211/CI_RoleCode/collaborator (since those links didn’t work and didn’t include all options). This affects these resources:
      * "Critical Micelle Concentration (CMC) Data Collection" (https://resources.psdi.ac.uk/data/a7c82670-d2e2-46c6-920a-74294289aa34 )
      * "Physical Chemistry Properties Data Collection" (https://resources.psdi.ac.uk/data/44160b2f-5938-442e-9f0a-652eb55d1c2b )
      ...
      * "PSDI Data Revival" (https://resources.psdi.ac.uk/resource-theme/1d0c399d-2fc8-4b10-abcd-cd17ef0bcb8d )
* Updates to psdi-dcat-shacl.jsonld and psdi-dcat-shacl.ttl to reflect the changes in qualified attribution role values
